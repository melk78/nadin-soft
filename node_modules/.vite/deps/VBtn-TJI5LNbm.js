import { computed, createBaseVNode, createVNode, inject, mergeProps, nextTick, normalizeClass, normalizeStyle, onBeforeUnmount, onMounted, onUpdated, provide, reactive, ref, toDisplayString, toRef, unref, useId, watch, watchEffect, withDirectives } from "./vue.runtime.esm-bundler-D72dexdH.js";
import { useProxiedModel } from "./proxiedModel-Bd4Dvody.js";
import { PREFERS_REDUCED_MOTION, clamp, consoleWarn, convertToUnit, deepEqual, findChildrenWithProvide, genericComponent, getCurrentInstance, propsFactory, wrapInArray } from "./defineComponent-FdLknxcT.js";
...
import { useTextColor } from "./color-CxSgwpeO.js";
...
import { VBtnGroup, makeVBtnGroupProps } from "./VBtnGroup-Dwelh0oM.js";
import { VIcon, makeSizeProps, useSize } from "./VIcon-vZ9vfGSb.js";
import { makeLoaderProps, makeLocationProps, makePositionProps, useIntersectionObserver, useLoader, useLocation, usePosition } from "./position-B_i8SPkN.js";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VBtn/VBtn.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VBtnToggle/VBtnToggle.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VProgressCircular/VProgressCircular.css";
...
const VBtn = genericComponent()({
	...
	setup(props, _ref) {
		...
		function onClick(e) {
			...
			if (link.isLink.value) link.navigate?.(e);
			else group?.toggle();
		}
...
//#endregion
export { VBtn, VBtnToggle, VBtnToggleSymbol, VProgressCircular, makeGroupItemProps, makeGroupProps, makeVBtnProps, useGroup, useGroupItem };
//# sourceMappingURL=VBtn-TJI5LNbm.js.map