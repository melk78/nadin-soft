import { Fragment, Transition, capitalize, cloneVNode, computed, createBaseVNode, createTextVNode, createVNode, effectScope, guardReactiveProps, inject, markRaw, mergeProps, nextTick, normalizeClass, normalizeProps, normalizeStyle, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onMounted, onScopeDispose, onUnmounted, provide, reactive, readonly, ref, shallowRef, toDisplayString, toRaw, toRef, toRefs, toValue, unref, useId, vModelText, vShow, watch, watchEffect, withDirectives, withModifiers } from "./vue.runtime.esm-bundler-D72dexdH.js";
import { useProxiedModel, useToggleScope } from "./proxiedModel-Bd4Dvody.js";
import { CircularBuffer, EventProp, IN_BROWSER, PREFERS_REDUCED_MOTION, SUPPORTS_EYE_DROPPER, SUPPORTS_MATCH_MEDIA, callEvent, camelizeProps, checkPrintable, clamp, consoleError, consoleWarn, convertToUnit, createRange, debounce, deepEqual, defineComponent, defineFunctionalComponent, ensureValidVNode, escapeForRegex, extractNumber, filterInputAttrs, focusChild, focusableChildren, genericComponent, getCurrentInstance, getCurrentInstanceName, getDecimals, getEventCoordinates, getNextElement, getObjectValueByPath, getPropertyFromItem, has, humanReadableFileSize, isClickInsideElement, isComposingIgnoreKey, isEmpty, isOn, keyValues, matchesSelector, noop, omit, pick, pickWithRest, propsFactory, provideDefaults, refElement, renderSlot, templateRef, wrapInArray } from "./defineComponent-FdLknxcT.js";
import { toPhysical } from "./anchor-3kYtsOMZ.js";
import { animate, nullifyTransforms } from "./animation-BQLBTo32.js";
import { VMenuSymbol, VOverlay, VTooltip, getScrollParent, makeDelayProps, makeVOverlayProps, useDelay, useHydration } from "./VTooltip-IZgZZnGF.js";
import { HSLtoHSV, HSVtoCSS, HSVtoHSL, HSVtoHex, HSVtoRGB, HexToHSV, RGBtoCSS, RGBtoHSV, getContrast, makeThemeProps, parseColor, provideTheme, useTheme } from "./theme-_gYK0WIA.js";
import { makeComponentProps, useRender } from "./useRender-BKE6PnJj.js";
import { createSimpleFunctional } from "./createSimpleFunctional-BVgWhQRY.js";
import { standardEasing } from "./easing-BSfObiKq.js";
import { provideLocale, useLocale, useRtl } from "./locale-Dxy1CFSU.js";
import { createDateRange, useDate } from "./date-fGPqfN0L.js";
import { makeDisplayProps, useDisplay } from "./display-DzJZmQm0.js";
import "./goto-CN1OR4j7.js";
import { IconValue, VClassIcon, VComponentIcon, VLigatureIcon, VSvgIcon } from "./icons-DfJZwaBj.js";
import { useResizeObserver } from "./resizeObserver-DmPjYZxw.js";
import { VuetifyLayoutKey, createLayout, makeLayoutItemProps, makeLayoutProps, useLayout, useLayoutItem } from "./layout-DsGT_hqe.js";
import { intersect_default } from "./intersect-C4OHoOGC.js";
import { makeRouterProps, ripple_default, useLink, useRouter } from "./router-0YliGuXD.js";
import { forwardRefs, makeLazyProps, useLazy, useScopeId } from "./forwardRefs-utFle_WK.js";
import { useBackgroundColor, useTextColor } from "./color-CxSgwpeO.js";
import { makeDimensionProps, useDimension } from "./dimensions-CjdKB0o0.js";
import { MaybeTransition, makeTransitionProps } from "./transition-Ci4Oc7_H.js";
import { VApp } from "./VApp-C6EnO4h-.js";
import { makeTagProps } from "./tag-DUDotKQv.js";
import { VAppBar, VAppBarNavIcon, VAppBarTitle, VToolbar, VToolbarTitle } from "./VAppBar-BXhF-i-Y.js";
import { VDialogBottomTransition, VDialogTopTransition, VDialogTransition, VExpandTransition, VExpandXTransition, VFabTransition, VFadeTransition, VScaleTransition, VScrollXReverseTransition, VScrollXTransition, VScrollYReverseTransition, VScrollYTransition, VSlideXReverseTransition, VSlideXTransition, VSlideYReverseTransition, VSlideYTransition } from "./transitions-Cq9JnlQD.js";
import { VDefaultsProvider } from "./VDefaultsProvider-BDQZlAMa.js";
import { VImg, VResponsive, makeVImgProps } from "./VImg-CNRaSE83.js";
import { genOverlays, makeBorderProps, makeDensityProps, makeRoundedProps, makeVariantProps, useBorder, useDensity, useRounded, useVariant } from "./variant-DmOVCQ8k.js";
import { makeElevationProps, useElevation } from "./elevation-BJdVoOK7.js";
import { useSsrBoot } from "./ssrBoot-DQhZP_qr.js";
import { VBtnGroup } from "./VBtnGroup-Dwelh0oM.js";
import { VBtn, VBtnToggle, VBtnToggleSymbol, VProgressCircular, makeGroupItemProps, makeGroupProps, makeVBtnProps, useGroup, useGroupItem } from "./VBtn-TJI5LNbm.js";
import { VIcon, makeSizeProps, useSize } from "./VIcon-vZ9vfGSb.js";
import { LoaderSlot, VProgressLinear, makeLoaderProps, makeLocationProps, makePositionProps, useIntersectionObserver, useLoader, useLocation, usePosition } from "./position-B_i8SPkN.js";
import "./VBtn-JFqgJX1j.js";
import { VAvatar } from "./VAvatar-CcDJc2L3.js";
import { VSlideGroup, VSlideGroupSymbol, VTab, VTabs, VTabsWindow, VTabsWindowItem, VWindow, VWindowItem, makeVSlideGroupProps, makeVWindowItemProps, makeVWindowProps } from "./VTabs-CbvVYOmF.js";
import { VDivider } from "./VDivider-CZTbAe80.js";
import { VList, VListGroup, VListImg, VListItem, VListItemAction, VListItemMedia, VListItemSubtitle, VListItemTitle, VListSubheader, makeItemsProps, makeVListGroupProps, makeVListItemProps, makeVListProps, transformItem as transformItem$2, useItems, useListItems } from "./VList-BFvjw8o9.js";
import "./VBtnGroup-CoZeLC9_.js";
import { VCard, VCardActions, VCardItem, VCardSubtitle, VCardText, VCardTitle } from "./VCard-zciGvCwv.js";
import { VCol, VContainer, VRow, VSpacer } from "./VGrid-3KO1qBSi.js";
import { VMain } from "./VMain-ByizRghR.js";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VAlert/VAlert.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VAutocomplete/VAutocomplete.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VCheckbox/VCheckbox.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSelectionControl/VSelectionControl.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VLabel/VLabel.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSelectionControlGroup/VSelectionControlGroup.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VInput/VInput.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VMessages/VMessages.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VChip/VChip.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VChipGroup/VChipGroup.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VMenu/VMenu.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSelect/VSelect.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VTextField/VTextField.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VCounter/VCounter.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VField/VField.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VVirtualScroll/VVirtualScroll.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VBadge/VBadge.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VBanner/VBanner.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VBottomNavigation/VBottomNavigation.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VBottomSheet/VBottomSheet.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VDialog/VDialog.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VBreadcrumbs/VBreadcrumbs.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VCarousel/VCarousel.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VCode/VCode.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VColorPicker/VColorPicker.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VColorPicker/VColorPickerCanvas.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VColorPicker/VColorPickerEdit.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VColorPicker/VColorPickerPreview.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSlider/VSlider.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSlider/VSliderThumb.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSlider/VSliderTrack.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VColorPicker/VColorPickerSwatches.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/labs/VPicker/VPicker.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSheet/VSheet.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VCombobox/VCombobox.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VDataTable/VDataTable.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VDataTable/VDataTableFooter.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VPagination/VPagination.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VTable/VTable.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VDatePicker/VDatePicker.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VDatePicker/VDatePickerControls.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VDatePicker/VDatePickerHeader.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VDatePicker/VDatePickerMonth.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VDatePicker/VDatePickerMonths.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VDatePicker/VDatePickerYears.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VEmptyState/VEmptyState.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VExpansionPanel/VExpansionPanel.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VFab/VFab.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VFileInput/VFileInput.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VFooter/VFooter.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VInfiniteScroll/VInfiniteScroll.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VItemGroup/VItemGroup.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VKbd/VKbd.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VLayout/VLayout.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VLayout/VLayoutItem.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VLocaleProvider/VLocaleProvider.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VNavigationDrawer/VNavigationDrawer.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VNumberInput/VNumberInput.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VOtpInput/VOtpInput.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VParallax/VParallax.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VRadioGroup/VRadioGroup.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VRating/VRating.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSkeletonLoader/VSkeletonLoader.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSnackbar/VSnackbar.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSpeedDial/VSpeedDial.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VStepper/VStepper.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VStepper/VStepperItem.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSwitch/VSwitch.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VSystemBar/VSystemBar.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VTextarea/VTextarea.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VThemeProvider/VThemeProvider.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VTimeline/VTimeline.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VTimePicker/VTimePicker.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VTimePicker/VTimePickerClock.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VTimePicker/VTimePickerControls.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VTreeview/VTreeviewItem.css";
...
const VMenu = genericComponent()({
	...
	setup(props, _ref) {
		...
		watch(isActive, (val) => {
			if (val) {
				parent?.register();
				if (IN_BROWSER && !props.disableInitialFocus) document.addEventListener("focusin", onFocusIn, { once: true });
			} else {
				parent?.unregister();
				...
				additional: (_ref2) => {
					...
					return createBaseVNode(Fragment, null, [!props.hideDelimiters && createBaseVNode("div", {
						...
						return slots.item ? slots.item({
							props: props$1,
							item
						}) : createVNode(VBtn, mergeProps(item, props$1), null);
...
//#endregion
//#region node_modules/vuetify/lib/components/VColorPicker/VColorPickerCanvas.js
...
const VColorPickerEdit = defineComponent({
	...
	setup(props, _ref2) {
		...
		useRender(() => createBaseVNode("div", {
			...
			"style": normalizeStyle(props.style)
		}, [inputs.value?.map((props$1) => createVNode(VColorPickerInput, props$1, null)), enabledModes.value.length > 1 && createVNode(VBtn, {
			"icon": "$unfold",
			"size": "x-small",
			"variant": "plain",
...
const useSlider = (_ref) => {
	...
	function parseMouseMove(e) {
		...
		const clickOffset = getPosition(e, position$1);
...
const VSliderThumb = genericComponent()({
	...
	setup(props, _ref) {
		...
		const { min, max, thumbColor, thumbLabelColor, step, disabled, thumbSize, thumbLabel, direction, isReversed, vertical, readonly: readonly$1, elevation, mousePressed, decimals, indexFromEnd } = slider;
		...
		useRender(() => {
			...
			return createBaseVNode("div", {
				...
				"onKeydown": !readonly$1.value ? onKeydown : void 0
			}, [
				createBaseVNode("div", {
					"class": normalizeClass([
				...
				}, [createBaseVNode("div", null, [slots["thumb-label"]?.({ modelValue: props.modelValue }) ?? props.modelValue.toFixed(step.value ? decimals.value : 1)]), createBaseVNode("div", { "class": "v-slider-thumb__label-wedge" }, null)])]), [[vShow, thumbLabel.value && props.focused || thumbLabel.value === "always"]])] })
			]);
		});
		return {};
	}
...
const VSlider = genericComponent()({
	...
	setup(props, _ref) {
		...
		const { min, max, mousePressed, roundValue, onSliderMousedown, onSliderTouchstart, trackContainerRef, position, hasLabels, disabled, readonly: readonly$1, noKeyboard } = useSlider({
			props,
			steps,
			onSliderStart: () => {
			...
			return createVNode(VInput, mergeProps({
				...
				default: (_ref4) => {
					...
					return createBaseVNode("div", {
						...
						"onMousedown": !readonly$1.value ? onSliderMousedown : void 0,
						"onTouchstartPassive": !readonly$1.value ? onSliderTouchstart : void 0
					}, [
						createBaseVNode("input", {
							"id": id.value,
							"name": props.name || id.value,
							"disabled": !!disabled.value,
							"readonly": !!readonly$1.value,
							"tabindex": "-1",
							"value": model.value
						}, null),
...
//#endregion
//#region node_modules/vuetify/lib/util/colors.js
const red = {
	base: "#f44336",
	lighten5: "#ffebee",
	lighten4: "#ffcdd2",
		...
		const search = computed({
			...
			set: async (val) => {
				...
				if (val && props.multiple && props.delimiters?.length) {
					...
					const values = val.split(/* @__PURE__ */ new RegExp(`(?:${signsToMatch})+`));
					if (values.length > 1) {
						for (let v of values) {
							v = v.trim();
							if (v) {
...
function provideSelection(props, _ref9) {
	...
	const selected = useProxiedModel(props, "modelValue", props.modelValue, (v) => {
		return new Set(wrapInArray(v).map((v$1) => {
			return allItems.value.find((item) => props.valueComparator(v$1, item.value))?.value ?? v$1;
		}));
	}, (v) => {
		return [...v.values()];
	});
	...
	setup(props, _ref) {
		...
		useRender(() => createVNode(props.tag, {
			...
			createVNode(MaybeTransition, { "transition": props.transition }, { default: () => [props.loading ? createVNode(LoaderSlot, {
				...
				"active": true
			}, { default: (slotProps$1) => slots.loader?.(slotProps$1) }) : createBaseVNode("div", { "key": "items" }, [!paginatedItems.value.length ? slots["no-data"]?.() : slots.default?.(slotProps.value)])] }),
...
const VTable = genericComponent()({
	...
	setup(props, _ref) {
		...
		const { densityClasses } = useDensity(props);
		useRender(() => {
			const tableContentDefaults = { VCheckboxBtn: { density: props.density } };
			return createVNode(props.tag, {
				"class": normalizeClass([
					"v-table",
					{
				...
				slots.top?.(),
				createVNode(VDefaultsProvider, { "defaults": tableContentDefaults }, { default: () => [slots.default ? createBaseVNode("div", {
...
const VFileInput = genericComponent()({
	...
	setup(props, _ref) {
		...
		useRender(() => {
			...
			const inputAccept = attrs.webkitdirectory !== void 0 && attrs.webkitdirectory !== false ? void 0 : props.filterByType ?? String(attrs.accept);
			return createVNode(VInput, mergeProps({
				"ref": vInputRef,
		...
		function intersecting(side) {
			...
			function done(status$1) {
				...
				nextTick(() => {
					...
					if (status$1 === "ok" && side === "start") setScrollAmount(getScrollSize() - previousScrollSize + getScrollAmount());
...
function useTouch(_ref) {
	...
	let start;
	function getOffset$1(pos, active) {
	...
	function onTouchstart(e) {
		...
		if (inTouchZone || inElement || isActive.value && isTemporary.value) {
			start = [touchX, touchY];
			offset.value = getOffset$1(isHorizontal.value ? touchX : touchY, isActive.value);
	...
	function onTouchmove(e) {
		...
		if (progress > 1) offset.value = getOffset$1(isHorizontal.value ? touchX : touchY, true);
		else if (progress < 0) offset.value = getOffset$1(isHorizontal.value ? touchX : touchY, false);
	}
...
const VNumberInput = genericComponent()({
	...
	setup(props, _ref) {
		...
		watchEffect(() => {
			if (isFocused.value && !controlsDisabled.value && Number(_inputText.value) === model.value) {} else if (model.value == null) _inputText.value = null;
...
const VRangeSlider = genericComponent()({
	...
	setup(props, _ref) {
		...
		const { activeThumbRef, hasLabels, max, min, mousePressed, onSliderMousedown, onSliderTouchstart, position, trackContainerRef, readonly: readonly$1 } = useSlider({
			props,
			steps,
			onSliderStart: () => {
				emit("start", model.value);
...
const VTimePickerControls = genericComponent()({
	...
	setup(props, _ref) {
		...
		useRender(() => {
			let hour = props.hour;
			if (props.ampm) hour = hour ? (hour - 1) % 12 + 1 : 12;
			return createBaseVNode("div", { "class": "v-time-picker-controls" }, [createBaseVNode("div", { "class": normalizeClass({
				...
				createBaseVNode("span", { "class": normalizeClass(["v-time-picker-controls__time__separator", { "v-time-picker-controls--with-seconds__time__separator": props.useSeconds }]) }, [createTextVNode(":")]),
				createVNode(VBtn, {
				...
				props.useSeconds && createBaseVNode("span", {
					"class": normalizeClass(["v-time-picker-controls__time__separator", { "v-time-picker-controls--with-seconds__time__separator": props.useSeconds }]),
					"key": "secondsDivider"
				}, [createTextVNode(":")]),
				props.useSeconds && createVNode(VBtn, {
					"key": "secondsVal",
...
const VTimePicker = genericComponent()({
	...
	setup(props, _ref) {
		...
		function convert12to24(hour, period$1) {
			return hour % 12 + (period$1 === "pm" ? 12 : 0);
		}
