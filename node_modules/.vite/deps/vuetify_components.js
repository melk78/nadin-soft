import { Fragment, capitalize, computed, createBaseVNode, createTextVNode, createVNode, effectScope, guardReactiveProps, inject, mergeProps, nextTick, normalizeClass, normalizeProps, normalizeStyle, onBeforeMount, onBeforeUnmount, onBeforeUpdate, onDeactivated, onMounted, onScopeDispose, onUnmounted, provide, reactive, ref, shallowRef, toDisplayString, toRaw, toRef, toRefs, toValue, unref, useId, vModelText, vShow, watch, watchEffect, withDirectives, withModifiers } from "./vue.runtime.esm-bundler-D72dexdH.js";
import { EventProp, IN_BROWSER, PREFERS_REDUCED_MOTION, SUPPORTS_EYE_DROPPER, SUPPORTS_MATCH_MEDIA, callEvent, camelizeProps, checkPrintable, clamp, consoleError, consoleWarn, convertToUnit, createRange, debounce, deepEqual, defineComponent, defineFunctionalComponent, ensureValidVNode, escapeForRegex, filterInputAttrs, focusChild, focusableChildren, genericComponent, getCurrentInstance, getDecimals, getEventCoordinates, getNextElement, getObjectValueByPath, getPropertyFromItem, has, humanReadableFileSize, isClickInsideElement, isComposingIgnoreKey, isEmpty, isOn, keyValues, matchesSelector, noop, omit, pick, pickWithRest, propsFactory, provideDefaults, refElement, renderSlot, templateRef, wrapInArray } from "./defineComponent-Dz-_BdZg.js";
import { makeComponentProps, useRender } from "./useRender-C-FT7xyL.js";
import { useProxiedModel, useToggleScope } from "./proxiedModel-pSL3svcX.js";
import "./anchor-D38nYSLN.js";
import "./animation-BQLBTo32.js";
import { VMenuSymbol, VOverlay, getScrollParent, makeVOverlayProps, useHydration } from "./VOverlay-CAw9kufa.js";
import { HSLtoHSV, HSVtoCSS, HSVtoHSL, HSVtoHex, HSVtoRGB, HexToHSV, RGBtoCSS, RGBtoHSV, getContrast, makeThemeProps, parseColor, provideTheme, useTheme } from "./theme-h65ayrCH.js";
import { createSimpleFunctional } from "./createSimpleFunctional-DIuj-f7u.js";
import "./easing-Dv_s-_U7.js";
import { useForm } from "./form-Yudg0yps.js";
import { forwardRefs } from "./forwardRefs-8N5qcp87.js";
import { VForm } from "./VForm-DtidNO9X.js";
import { provideLocale, useLocale, useRtl } from "./locale-CFpsWEx1.js";
import { createDateRange, useDate } from "./date-CioiW1Bh.js";
import { makeDisplayProps, useDisplay } from "./display-ByTS_iV9.js";
import "./goto-D5eciX7X.js";
import { IconValue, VClassIcon, VComponentIcon, VLigatureIcon, VSvgIcon } from "./icons-Cvqa-YK6.js";
import { useResizeObserver } from "./resizeObserver-D97-Sro_.js";
import { VuetifyLayoutKey, createLayout, makeLayoutItemProps, makeLayoutProps, useLayout, useLayoutItem } from "./layout-dDSN9R_8.js";
import { VApp } from "./VApp-D3yS_c5e.js";
import { makeTagProps } from "./tag-vlkYG7tY.js";
import { VToolbar, VToolbarTitle } from "./VToolbar-BCycRbFn.js";
import { VDialogBottomTransition, VDialogTopTransition, VDialogTransition, VExpandTransition, VExpandXTransition, VFabTransition, VFadeTransition, VScaleTransition, VScrollXReverseTransition, VScrollXTransition, VScrollYReverseTransition, VScrollYTransition, VSlideXReverseTransition, VSlideXTransition, VSlideYReverseTransition, VSlideYTransition } from "./transitions-Ci09YZH0.js";
import { VDefaultsProvider } from "./VDefaultsProvider-CtX2fcx5.js";
import { makeDimensionProps, useDimension } from "./dimensions-KH8uJhiE.js";
import { VImg, VResponsive, makeVImgProps } from "./VImg-NcveHgnk.js";
import { useBackgroundColor, useTextColor } from "./color-ETSglfut.js";
import { makeRoundedProps, useRounded } from "./rounded-vOX0OjBM.js";
import { MaybeTransition, makeTransitionProps } from "./transition-CTnl6FBg.js";
import { intersect_default } from "./intersect-mp2Tn-M5.js";
import { makeBorderProps, useBorder } from "./border-HL-gLqdp.js";
import { makeElevationProps, useElevation } from "./elevation-BHzehScM.js";
import { VAppBar, VAppBarNavIcon, VAppBarTitle } from "./VAppBar-CE7Hhm_9.js";
import { useSsrBoot } from "./ssrBoot-BFUfVdtB.js";
import { makeDensityProps, useDensity } from "./density-BtO4U0lf.js";
import { genOverlays, makeVariantProps, useVariant } from "./variant-2-GSSw3U.js";
import { VBtnGroup } from "./VBtnGroup-DhhANH0y.js";
import { VBtn, VBtnToggle, VBtnToggleSymbol, VProgressCircular, makeGroupItemProps, makeGroupProps, makeVBtnProps, useGroup, useGroupItem } from "./VBtn-U9L2QqkG.js";
import { VIcon, makeSizeProps, useSize } from "./VIcon-B_6inC18.js";
import { LoaderSlot, VProgressLinear, makeLoaderProps, makeLocationProps, useIntersectionObserver, useLoader, useLocation } from "./loader-DNFZOTzq.js";
import { makePositionProps, usePosition } from "./position-CjeVHYV8.js";
import { makeRouterProps, useLink } from "./router-CNtevCCT.js";
import { ripple_default } from "./ripple-Dtb8ShCQ.js";
import "./VBtn-NDb3JlOp.js";
import { VCard, VCardActions, VCardItem, VCardSubtitle, VCardText, VCardTitle } from "./VCard-lyW3EWFa.js";
import { VAvatar } from "./VAvatar-B1-lr_RS.js";
import "./VBtnGroup-GeuNNcEV.js";
import { makeDelayProps, useDelay } from "./delay-Bm2aa_uC.js";
import { makeLazyProps, useLazy } from "./lazy-9OfS-hbG.js";
import { useScopeId } from "./scopeId-BSnb2Kiz.js";
import { VDialog, makeVDialogProps } from "./VDialog-Dn1efjhR.js";
import { VCol, VContainer, VRow, VSpacer } from "./VGrid-eeY0ESXs.js";
import { VList, VListGroup, VListImg, VListItem, VListItemAction, VListItemMedia, VListItemSubtitle, VListItemTitle, VListSubheader, makeItemsProps, makeVListGroupProps, makeVListItemProps, makeVListProps, transformItem as transformItem$2, useItems, useListItems } from "./VList-CFKLJfam.js";
import { VDivider } from "./VDivider-BJrrhXR7.js";
import { VMain } from "./VMain-C0ueCFxO.js";
import { VCounter, VField, VFieldLabel, VInput, VLabel, VMessages, VTextField, makeAutocompleteProps, makeFocusProps, makeVFieldProps, makeVInputProps, makeVTextFieldProps, makeValidationProps, useAutocomplete, useAutofocus, useFocus, useValidation } from "./VTextField-Di4t6Unz.js";
import { VSlideGroup, VSlideGroupSymbol, VTab, VTabs, VTabsWindow, VTabsWindowItem, VWindow, VWindowItem, makeVSlideGroupProps, makeVWindowItemProps, makeVWindowProps } from "./VTabs-NgbdMRck.js";
import "./touch-Blm7VMZw.js";
import "./VTextField-CVyEo4ek.js";
import { VConfirmEdit } from "./VConfirmEdit-BrBSOZro.js";
import { VNavigationDrawer } from "./VNavigationDrawer-3yLXzn8N.js";
import { VNumberInput } from "./VNumberInput-C7sR5Zap.js";
import { VToolbarItems } from "./VToolbar-DkLUrFzU.js";
import { VTooltip } from "./VTooltip-BJhAoUQg.js";
