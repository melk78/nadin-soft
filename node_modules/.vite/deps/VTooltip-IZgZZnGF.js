import { Fragment, Teleport, Transition, computed, createBaseVNode, createVNode, effectScope, inject, mergeProps, nextTick, onBeforeUnmount, onMounted, onScopeDispose, provide, reactive, readonly, ref, shallowRef, toRaw, toRef, toValue, useId, vShow, warn, watch, watchEffect, withDirectives } from "./vue.runtime.esm-bundler-D72dexdH.js";
import { useProxiedModel, useToggleScope } from "./proxiedModel-Bd4Dvody.js";
import { CircularBuffer, IN_BROWSER, clamp, consoleError, convertToUnit, deepEqual, defer, destructComputed, eventName, genericComponent, getCurrentInstance, isOn, matchesSelector, omit, propsFactory, templateRef } from "./defineComponent-FdLknxcT.js";
import { flipAlign, flipCorner, flipSide, getAxis, parseAnchor } from "./anchor-3kYtsOMZ.js";
import { Box, animate, getElementBox, getOverflow, getTargetBox, nullifyTransforms } from "./animation-BQLBTo32.js";
...
import { useRtl } from "./locale-Dxy1CFSU.js";
import { useDisplay } from "./display-DzJZmQm0.js";
import { useBackButton, useRouter } from "./router-0YliGuXD.js";
import { forwardRefs, makeLazyProps, useLazy, useScopeId } from "./forwardRefs-utFle_WK.js";
import { useBackgroundColor } from "./color-CxSgwpeO.js";
...
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VTooltip/VTooltip.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VOverlay/VOverlay.css";
	...
	function updateLocation() {
		...
		while (true) {
			...
			}
			{
				...
				if (!props.stickToTarget) x += overflows$1.x.before;
				contentBox.x += overflows$1.x.before;
				if (!props.stickToTarget) y += overflows$1.y.before;
...
//#endregion
export { ClickOutside, VMenuSymbol, VOverlay, VTooltip, getScrollParent, makeDelayProps, makeVOverlayProps, useDelay, useHydration };
//# sourceMappingURL=VTooltip-IZgZZnGF.js.map