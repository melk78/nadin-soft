import { Fragment, computed, createBaseVNode, createVNode, inject, mergeProps, normalizeClass, normalizeStyle, onBeforeMount, onBeforeUnmount, provide, ref, shallowRef, toDisplayString, toRaw, toRef, toValue, vShow, watch, watchEffect, withDirectives } from "./vue.runtime.esm-bundler-D72dexdH.js";
import { EventProp, consoleError, deepEqual, defineComponent, deprecate, focusChild, genericComponent, getCurrentInstance, getPropertyFromItem, isPrimitive, omit, pick, propsFactory, provideDefaults, wrapInArray } from "./defineComponent-Dz-_BdZg.js";
import { makeComponentProps, useRender } from "./useRender-C-FT7xyL.js";
import { useProxiedModel } from "./proxiedModel-pSL3svcX.js";
...
import { VExpandTransition } from "./transitions-Ci09YZH0.js";
...
import { MaybeTransition } from "./transition-CTnl6FBg.js";
...
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VList/VList.css";
import "/home/maryam/nadinSoft/project/node_modules/vuetify/lib/components/VList/VListItem.css";
...
const useNestedItem = (id, isDisabled, isGroup) => {
	...
	onBeforeMount(() => {
		if (!parent.isGroupActivator) parent.root.register(computedId.value, parent.id.value, toValue(isDisabled), isGroup);
	});
	onBeforeUnmount(() => {
...
//#endregion
export { VList, VListGroup, VListImg, VListItem, VListItemAction, VListItemMedia, VListItemSubtitle, VListItemTitle, VListSubheader, makeItemsProps, makeVListGroupProps, makeVListItemProps, makeVListProps, transformItem$1 as transformItem, useItems, useListItems };
//# sourceMappingURL=VList-CFKLJfam.js.map